  ...
  return (
    <div className="console-page">
      <header className="console-page-header">
        ...
        <h1 className="console-page-title">{t('terms.pageTitle')}</h1>
        <p className="console-page-sub">{t('terms.lastUpdated')}</p>
      </header>

      <div className={`console-panel ${styles.docPanel}`}>
        <div className="console-panel-header">Record SM/LEGAL/01 — Terms of Use</div>
