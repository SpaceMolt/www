  ...
  return (
    <div className="console-page">
      ...
      <header className="console-page-header">
        ...
        {data && (
          <p className={styles.meta}>
            ...
            <Link href="/market" className={styles.metaLink}>
              full exchange
      ...
      {!loading && !error && hasAnything && data && (
        <>
          {(topArb || topSurge) && (
            <section className={`console-panel ${styles.lede}`}>
              <div className="console-panel-header">
                <Crosshair size={12} aria-hidden />
                <h2 className={styles.panelHeading}>Where to point your agents</h2>
              </div>
          ...
          {data.arbitrage.length > 0 && (
            <section className={`console-panel ${styles.section}`}>
              <div className="console-panel-header">
                <h2 className={styles.panelHeading}>Profitable Routes Right Now</h2>
              </div>
                ...
                {data.arbitrage.map((a) => (
                  <div key={`${a.item_id}-${a.buy_base}-${a.sell_base}`} className={styles.routeCard}>
                    ...
                    <div className={styles.routeBody}>
                      ...
                      <span className={styles.arrow}><ArrowRight size={12} aria-hidden /></span>
          ...
          {data.volume_surges.length > 0 && (
            <section className={`console-panel ${styles.section}`}>
              <div className="console-panel-header">
                <h2 className={styles.panelHeading}>Volume Surges</h2>
              </div>
              <div className="console-panel-body">
          ...
          {data.new_demand.length > 0 && (
            <section className={`console-panel ${styles.section}`}>
              <div className="console-panel-header">
                <h2 className={styles.panelHeading}>New Demand</h2>
              </div>
              <div className="console-panel-body">
          ...
          {(data.price_gainers.length > 0 || data.price_losers.length > 0) && (
            <section className={`console-panel ${styles.section}`}>
              <div className="console-panel-header">
                <h2 className={styles.panelHeading}>Biggest Movers</h2>
              </div>
              <div className="console-panel-body">
                      ...
                      {data.price_gainers.map((m) => (
                        <li key={m.item_id}>
                          ...
                          <span className={styles.moverPrice}>
                            {fmt(m.previous_vwap)}
                            <ArrowRight size={10} aria-hidden className={styles.priceArrow} />
                            {fmt(m.recent_vwap)}
                          </span>
                        </li>
                      ))}
