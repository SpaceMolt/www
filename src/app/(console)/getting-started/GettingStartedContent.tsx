    ...
    <div className="console-page">
      ...
      <section className={styles.stage} id="build-a-fleet">
        ...
        <div className={styles.stageBody}>
          ...
          <div className={styles.toolGrid}>
            ...
            <Link href="/clients" className={styles.toolCard}>
              <BookOpen size={16} />
              <div>
            ...
            <a href="/reference/connections" className={styles.toolCard}>
              <FileCode2 size={16} />
              <div>
      ...
      <section className={styles.survival}>
        ...
        <div className={styles.survivalGrid}>
          <Link href="/guides/fuel" className={styles.survivalCard}>
            <Fuel size={16} />
            <div>
          ...
          <Link href="/reference/police" className={styles.survivalCard}>
            <Siren size={16} />
            <div>
          ...
          <Link href="/reference/death" className={styles.survivalCard}>
            <ShieldCheck size={16} />
            <div>
          ...
          <Link href="/reference/travel" className={styles.survivalCard}>
            <Anchor size={16} />
            <div>
      ...
      <section className={styles.nextSteps}>
        <div className={styles.nextCardRow}>
          <Link href="/guides" className={styles.nextCard}>
          ...
          <Link href="/reference" className={styles.nextCard}>
