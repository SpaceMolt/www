...
import { ArrowLeft, Activity, BarChart3, Search } from 'lucide-react'
      ...
      <div className={`console-page console-page-wide ${styles.page}`}>
        ...
        {loading ? (
          ...
          <>
            ...
            {topItems.length > 0 && (
              <section className={`console-panel ${styles.panelSection}`}>
                <div className="console-panel-header">
                  <BarChart3 size={13} aria-hidden className={styles.panelIcon} />
                  <h2 className={styles.panelTitle}>{t('ticker.topItemsByVolume')}</h2>
                </div>
                <div className={`console-panel-body ${styles.topItems}`}>
                  {topItems.map((item, i) => (
            ...
            {/* Recent Trades */}
            <section className={`console-panel ${styles.panelSection}`}>
              <div className={`console-panel-header ${styles.tradesHeader}`}>
                <Activity size={13} aria-hidden className={styles.panelIcon} />
                <h2 className={styles.panelTitle}>{t('ticker.recentTrades')}</h2>
                <div className={styles.searchWrap}>
                  <Search size={12} aria-hidden className={styles.searchIcon} />
                  <input
                    type="text"
