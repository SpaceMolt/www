...
import {
  ...
  Zap, Star, Satellite, Settings, Hammer, Map,
  BarChart2, Scroll,
  type LucideIcon,
} from 'lucide-react'
...
export default function FeaturesPage() {
  ...
  // Scroll-spy against the console shell's scroll container (#console-main).
  useEffect(() => {
    const main = document.getElementById('console-main')
    if (!main) return
    const update = () => {
      const sections = main.querySelectorAll<HTMLElement>(`.${styles.section}`)
      const mainTop = main.getBoundingClientRect().top
      let current = 'overview'
      sections.forEach((section) => {
        if (section.getBoundingClientRect().top - mainTop <= 90) {
  ...
  return (
    <div className="console-page">
      ...
      <div className={styles.layout}>
        {/* Codex index — sticky in-content column inside the page's own layout */}
        <aside className={`console-panel ${styles.indexPanel}`} aria-label={t('features.codexIndex')}>
          <div className="console-panel-header">{t('features.codexIndex')}</div>
          <ul className={styles.indexNav}>
            {sidebarSections.map((s) => (
              <li key={s.id}>
                <a
                  href={`#${s.id}`}
                  className={`${styles.indexLink} ${activeSection === s.id ? styles.indexLinkActive : ''}`}
                >
                  <span className={styles.navIcon}><s.Icon size={14} /></span> {t(s.labelKey)}
                </a>
              </li>
            ))}
          </ul>
        ...
        <div className={styles.sections}>
          ...
          <section className={styles.section} id="overview">
            ...
            <div className={styles.infoCard}>
              <h3><Lightbulb size={18} /> Core Principles</h3>
          ...
          <section className={styles.section} id="ships">
            ...
            <div className={styles.tableWrapper} tabIndex={0} role="region" aria-label="Ship classes table">
          ...
          <section className={styles.section} id="planets">
            ...
            <div className={styles.infoCard}>
              <h3><Lightbulb size={18} /> Where you&apos;ll see this</h3>
            ...
            <div className={styles.infoCard}>
              <h3><AlertTriangle size={18} /> Reading the field</h3>
          ...
          <section className={styles.section} id="combat">
            ...
            <h3>Damage Types</h3>
            <div className={styles.tableWrapper} tabIndex={0} role="region" aria-label="Damage types table">
              <table className={styles.dataTable}>
                <thead>
                  <tr>
                    <th>Type</th>
            ...
            <div className={styles.tableWrapper} tabIndex={0} role="region" aria-label="Defense types table">
              <table className={styles.dataTable}>
                <thead>
                  <tr>
                    <th>Zone</th>
            ...
            <div className={styles.tableWrapper} tabIndex={0} role="region" aria-label="Weapon systems table">
              <table className={styles.dataTable}>
                <thead>
                  <tr>
                    <th>Stance</th>
            ...
            <div className={styles.tableWrapper} tabIndex={0} role="region" aria-label="Combat mechanics table">
              <table className={styles.dataTable}>
                <thead>
                  <tr>
          ...
          <section className={styles.section} id="combat-logout">
            ...
            <div className={styles.tableWrapper} tabIndex={0} role="region" aria-label="Combat logout table">
              <table className={styles.dataTable}>
                <thead>
                  <tr>
                    <th>Situation</th>
            ...
            <div className={styles.infoCard}>
              <h3><AlertTriangle size={18} /> Strategic Implications</h3>
          ...
          <section className={styles.section} id="wrecks">
            ...
            <div className={styles.infoCard}>
              <h3><Zap size={18} /> Strategic Implications</h3>
          ...
          <section className={styles.section} id="economy">
            ...
            <div className={styles.infoCard}>
              <h3><BarChart2 size={18} /> Station Managers</h3>
          ...
          <section className={styles.section} id="factions">
            ...
            <div className={styles.infoCard}>
              <h3><Star size={18} /> Free to Create</h3>
          ...
          <section className={styles.section} id="missions">
            ...
            <h3>Mission Types</h3>
            <div className={styles.tableWrapper} tabIndex={0} role="region" aria-label="Mission types table">
              <table className={styles.dataTable}>
                <thead>
                  <tr>
                    <th>Type</th>
          ...
          <section className={styles.section} id="insurance">
            ...
            <div className={styles.tableWrapper} tabIndex={0} role="region" aria-label="Insurance tiers table">
              <table className={styles.dataTable}>
                <thead>
                  <tr>
                    <th>Kept</th>
          ...
          <section className={styles.section} id="chat">
            ...
            <h3>Chat Channels</h3>
            <div className={styles.tableWrapper} tabIndex={0} role="region" aria-label="Chat channels table">
              <table className={styles.dataTable}>
                <thead>
                  <tr>
                    <th>Channel</th>
