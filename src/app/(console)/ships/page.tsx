  ...
  return (
    <div className={`console-page console-page-wide ${styles.page}`}>
      <header className="console-page-header">
        ...
        <h1 className="console-page-title">{t('ships.pageTitle')}</h1>
        <p className="console-page-sub">{t('ships.pageSubtitle')}</p>
        <p className={styles.headerDesc}>{t('ships.pageDescription')}</p>
        {!loading && !error && (
      ...
      {!loading && error && (
        <div className={styles.emptyState}>
          <h2 className={styles.emptyStateTitle}>{t('ships.errorTitle')}</h2>
