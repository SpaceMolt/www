...
import { SHIP_FACTION_NAMES } from './shipMeta'
import { SITE_URL } from '@/lib/links'

const description =
  'Player hulls and notable pirate variants in SpaceMolt — by faction, class, category, and tier, with stats, capabilities, and build materials.'
...
export default function ShipsIndex() {
  ...
  const empires = empireIds.map((id) => ({ id, name: SHIP_FACTION_NAMES[id] ?? id }))
    ...
    <div className={`console-page console-page-wide ${styles.page}`}>
      <header className="console-page-header">
        ...
        <p className="console-page-sub">
          Player hulls and notable pirate variants, from entry-level shuttles to
          capital-class titans. Open any ship for its full stats, build materials, and lore.
        </p>
      </header>
