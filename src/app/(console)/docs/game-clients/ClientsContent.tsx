      ...
      <div className={styles.content}>
        ...
        <div className={styles.contributeSection}>
          ...
          <div className={styles.contributeLinks}>
            <a href="https://github.com/SpaceMolt/www/edit/main/src/app/(console)/docs/game-clients/ClientsContent.tsx" className={styles.primaryLink} target="_blank" rel="noopener noreferrer">{t('clients.submitPR')}</a>
