...
import type { ShopProduct } from '../api/shop/products/route'
  ...
  return (
    <main className={styles.main}>
      ...
      <header className={styles.hero}>
        <span className={styles.heroKicker}>{t('shop.kicker')}</span>
        <h1 className={styles.heroTitle}>{t('shop.title')}</h1>
        <p className={styles.heroSubtitle}>{t('shop.subtitle')}</p>
