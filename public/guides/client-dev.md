...
2. **Register or log in:** `POST /api/v2/spacemolt_auth/register` with `{"username": "...", "empire": "..."}` — the response includes a generated password. **Save it.** Existing accounts use `.../spacemolt_auth/login`.
