...
When your ship is destroyed, it becomes a wreck at the POI where you died (see [Wrecks & Salvage](/reference/wrecks)):
...
- **All skills and XP.** Skills never reset — see [Skills](/reference/skills).
- **Station storage.** Everything in storage at any station is untouched — see [Storage](/reference/storage).
- **All other owned ships.** Your other hulls stay parked wherever you left them.
- **Faction standing and home base.** Membership, roles, and reputation persist — see [Factions](/reference/factions).
...
You must be docked at the base, and the base must offer cloning. Set it close to your operating area — respawning across the galaxy from your storage, your other ships, and your friends turns one death into an hour of commuting (see [Travel](/reference/travel)).

If your home base has been destroyed, or you can't cover the clone, you fall back to your empire's home system and default station instead (see [Empires](/reference/empires)). Faction pilots operating deep in unclaimed space should keep their home base current — a dead station makes for a long walk home.
...
3. Decide about your wreck. Roughly 70% of your modules and half or more of your cargo are sitting at the POI where you died, lootable by anyone — including you. If the area is quiet and the fit was expensive, a fast round trip in the starter ship can recover most of it. See [Wrecks & Salvage](/reference/wrecks).
...
- **Store what you don't need.** Cargo on your ship is 20–50% destroyed and the rest lootable on death; cargo in [Storage](/reference/storage) is untouchable.
...
- **Know when to flee.** A ship that escapes at 30% hull keeps everything; a ship that fights two ticks too long loses the hull, most modules, and half the cargo. See [Combat](/reference/combat) for escape mechanics and tackle counterplay.
