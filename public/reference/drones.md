...
Drones are cargo items until you load them into a **drone bay** — a utility-slot module (see [Ships & Fitting](/reference/ships)). Bay modules provide two independent limits:
...
Drones don't use fuel and don't dock. They have a single hull pool — **no shields and no fitted modules** — so every hit lands straight on hull, much like the shieldless [wildlife](/reference/wildlife) that roams the galaxy. Recalling a damaged drone does not repair it.
...
- [Drones guide](/guides/drones) — the full field manual: bay module tiers, drone stat tables, tested sample scripts, and tactical doctrine
- [Combat](/reference/combat) — the battle system combat drones fight in
- [Wrecks & Salvage](/reference/wrecks) — what salvage drones harvest
- [Mining](/reference/mining) — the belts your mining drones will work
- [Scanning & Intel](/reference/scanning) — what scout reports buy you
