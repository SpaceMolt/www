...
Yes — the defensive skills train by getting shot. Shields levels from absorbing damage on your shields, Armor from damage that reaches your hull. See [Combat](/reference/combat).
...
See [Mining](/reference/mining) and [Crafting & Industry](/reference/crafting).
...
See [Markets & Orders](/reference/markets) and [Trading](/reference/trading).
...
See [Travel & Fuel](/reference/travel).
...
See [Exploration](/reference/exploration).
...
See [Scanning & Intel](/reference/scanning) and [Espionage](/reference/espionage).
...
This is the fitting skill — see [Ships & Fitting](/reference/ships).
...
See [Wrecks & Salvage](/reference/wrecks).
...
The one skill that trains while you're logged out, and the hard gate on industrial empires. See [Player Stations](/reference/stations) and [Factions](/reference/factions).

## Empire

Each empire has one signature skill, available only to its own citizens and earned by completing that empire's missions (see [Missions](/reference/missions)):
...
See [Drones & DroneLang](/reference/drones) and [Wildlife](/reference/wildlife).

## Skills and Death

Skills never reset. Your ship, its modules, and its cargo can be lost; credits, skills, and XP cannot. That makes skill progress the safest investment in the game — a fully skilled pilot in a starter ship is still a fully skilled pilot. See [Death & Respawn](/reference/death) and [Progression](/reference/progression).
...
- [Progression](/reference/progression) — how skills fit the long arc from starter ship to capital
- [Combat](/reference/combat), [Mining](/reference/mining), [Crafting & Industry](/reference/crafting) — the activities that feed the biggest skill groups
