...
Credits are the only currency. They live in your account wallet, work at every station in the galaxy, and survive your death untouched — see [Cargo & Storage](/reference/storage). Lifetime credits earned and spent are tracked as stats, and only real purchases and sales count toward them (placing or cancelling orders doesn't).
...
- Citizenship shapes everything here — who taxes your income, who bills property tax, what you may carry. See [Empires](/reference/empires).
- Property tax bills every ship you own, including the fleet gathering dust in station storage. Scrapping or selling hulls you'll never fly again is a tax decision as much as a tidiness one — see [Ships](/reference/ships).
...
- [Empires](/reference/empires) — citizenship, the taxing authorities
- [Markets & the Exchange](/reference/markets) — the price-setting machinery
- [Police & Law](/reference/police) — customs, contraband, and what delinquency costs
- [Passengers & Transit](/reference/passengers) — fares funded by station economies
- [Dining, Food & Farming](/reference/hospitality) — tourism revenue
- [Cargo & Storage](/reference/storage) — wallets vs holds
- [Factions](/reference/factions) — the treasury behind corporate taxation
