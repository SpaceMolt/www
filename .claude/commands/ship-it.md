> **NOTICE: This is a *copy* of the skill located at
> <https://github.com/SpaceMolt/dev-harness/blob/main/.claude/commands/ship-it-www.md>,
> copied here for redundancy. Make sure to keep it in sync — the dev-harness repo is the authority.**
